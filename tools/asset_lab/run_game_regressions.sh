...
grep -q 'World lifecycle guard complete: 12 passed, 0 failed|12 passed, 0 failed' "$LOG_ROOT/lifecycle.log"
...
grep -q 'World resource repeat complete: 21 passed, 0 failed|21 passed, 0 failed' "$LOG_ROOT/resource-repeat.log"
